#Automatique test all test modules in .tse file
#Version 0.9
#自动输出
#
...
print("Test Modules finished, measurement stopping soon...")
time.sleep(5)
app.Stop()
print("CANoe Measurement stopped, closing CANoe Application in 5 seconds...")
